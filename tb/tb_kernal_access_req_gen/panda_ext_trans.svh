...
class panda_kernal_access_req_gen_blk_ctrl_trans extends panda_blk_ctrl_abstract_trans;
	...
	rand bit[31:0] kernal_wgt_baseaddr; // 卷积核权重基地址
	rand bit[15:0] kernal_chn_n; // 通道数
	rand bit[15:0] kernal_num_n; // 核数
	rand kernal_sz_t kernal_shape; // 卷积核形状
	rand bit[15:0] ofmap_h; // 输出特征图高度
	...
	`uvm_object_utils_begin(panda_kernal_access_req_gen_blk_ctrl_trans)
		...
		`uvm_field_int(kernal_chn_n, UVM_DEFAULT | UVM_NOPRINT | UVM_DEC)
		`uvm_field_int(kernal_num_n, UVM_DEFAULT | UVM_NOPRINT | UVM_DEC)
		`uvm_field_enum(kernal_sz_t, kernal_shape, UVM_DEFAULT)
		`uvm_field_int(ofmap_h, UVM_DEFAULT | UVM_NOPRINT | UVM_DEC)
